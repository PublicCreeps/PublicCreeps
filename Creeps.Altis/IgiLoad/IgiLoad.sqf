...
if (isnil "IL_Variables") then
{
	...
	// Supported vehicles
	IL_Supported_Vehicles_OFFROAD = ["x", "x", "B_mas_mar_Offroad_01_F"];
	IL_Supported_Vehicles_VAN = ["x", "x", "x"];
	IL_Supported_Vehicles_HEMTT = ["B_Truck_01_mover_F", "Marinir_Truck_01_box_FG", "Marinir_Truck_01_transport_FG", "Marinir_Truck_01_covered_FG", "B_mas_mar_Truck_01_covered_F", "B_mas_mar_Truck_01_transport_F"];
	IL_Supported_Vehicles_KAMAZ = ["x", "x", "x"];
	IL_Supported_Vehicles_TEMPEST = ["x", "x"];
	IL_Supported_Vehicles_MOHAWK = ["x", "x", "Marinir_CH49_Mohawk_FG"];
	IL_Supported_Vehicles_CHINOOK = ["x", "CH_47F", "kyo_MH47E_HC", "kyo_MH47E_Ramp", "kyo_MH47E_base"];
	IL_Supported_Vehicles_MH9 = ["x", "B_mas_mar_Heli_Light_01_F"];
	...
	IL_Supported_MH9 = ["B_Heli_Light_01_F"];
	...
	IL_Supported_Cargo_Veh_HEMTT = IL_Supported_Quadbike + IL_Supported_VAN + IL_Supported_OFFROAD + IL_Supported_SUV + IL_Supported_Hatchback + IL_Supported_Ifrit + IL_Supported_Hunter + IL_Supported_Strider + IL_Supported_MH9;
