...
switch (playerSide) do
{
	...
	{
		//Seize Objects
        life_actions = life_actions + [player addAction["Objekte von Boden entfernen",life_fnc_seizeObjects,cursorTarget,0,false,false,"",'count(nearestObjects [player,["weaponholder"],3])>0']];
        //Polizeimarke
