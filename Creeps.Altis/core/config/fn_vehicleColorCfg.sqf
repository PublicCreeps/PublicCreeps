...
switch (_vehicle) do
{
	...
	case "C_SUV_01_F":
	{
		...
		[
			...
			["textures\notarzt_suv.paa","med"],
			["textures\civ_suv_asa.paa","asa"],
			["textures\adac_suv.paa","adac"]
		];
	};
	...
	case "C_Van_01_box_F":
	{
		...
		[
			...
			["textures\rtwfront.paa","med","textures\rtwback.paa"]
		];
	};
	...
	case "B_Heli_Light_01_F":
	{
		...
		[
			...
			["textures\asa_humminbird.paa","asa"],
			["textures\ADAC_Hummingbird.paa","adac"]
		];
	};
	...
	case "O_Heli_Light_02_unarmed_F":
	{
		...
		[
			...
			["textures\asa_orca_v2.paa","asa"],
			["textures\orca_adac1.paa","adac"]
		];
	};
	...
	case "B_MRAP_01_F":
	{
		...
		[
			...
			["textures\hunter_rebellvorn.paa","civ","textures\hunter_rebellhinten.paa"],
			...
			["textures\rebell_hunter_0.paa","civ","textures\rebell_hunter_1.paa"],
			["textures\rebell_hunter_typ3_teil1.paa","civ","textures\rebell_hunter_typ3_teil2.paa"],
			["textures\asa_hunter_frontv2.paa","asa","textures\asa_hunter_backv2.paa"]
	...
	case "O_MRAP_02_F":
	{
		...
		[
			...
			["textures\ifrit_rebellvorn.paa","civ","textures\ifrit_rebellhinten.paa"],
			["textures\rebell_ifrit_0.paa","civ","textures\rebell_ifrit_1.paa"],
			["textures\rebell_ifrit_typ3_teil1.paa","civ","textures\rebell_ifrit_typ3_teil2.paa"],
			["textures\asa_ifrit_front.paa","civ","textures\asa_ifrit_back.paa"]
		];
	};
	case "I_MRAP_03_F":
	{
	...
	case "B_Truck_01_mover_F":
	{
		_ret = 
		[
			["textures\hemtt_mover_adac.paa","adac"]
		];
	};
	...
	case "C_Offroad_01_repair_F":
	{
		_ret =
		[
			["textures\offroad_adac3.paa","adac"]
		];
	};
};
