...
switch(_shop) do
{
	...
	case "adacw":
	{
		...
		{
			case (playerSide != civilian): {"Du bist kein Zivilist!"};
			case (!license_civ_adac): {"Du bist kein ADAC Mitglied"};
			default
			{
				["ADAC Shop",
					[
	...
	case "asawaffen":
	{
		...
		{
			case (playerSide != civilian): {"Du bist kein Zivilist!"};
			case (!license_civ_asa): {"Du bist kein Mitglied der ASA!"};
			default
			{
				["ASA Waffen",
					[
						...
						["SMG_01_F",nil,25000],
						["30Rnd_45ACP_Mag_SMG_01",nil,500],
						["arifle_SDAR_F","SDAR Unterwasserwaffe",10000],
