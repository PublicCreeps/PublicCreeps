...
switch (_shop) do
{
	...
	case "adac_car":
	{
		...
		{
			_return set[count _return,["C_Offroad_01_repair_F",12500]];
			_return set[count _return,["B_Truck_01_mover_F",250000]];
	...
	case "don_car":
	{
		if(__GETC__(life_donator) == 1) then
		{
			...
			_return set[count _return,["B_G_Offroad_01_F",9375]];
            _return set[count _return,["C_Offroad_01_F",9500]];
			_return set[count _return,["B_G_Offroad_01_armed_F",3750000]];
			...
			_return set[count _return,["I_Truck_02_transport_F",150000]];
			...
			_return set[count _return,["O_Truck_03_device_F",7500000]];
	...
	case "don_air":
	{
		if(__GETC__(life_donator) == 1) then
		{
			...
			_return set[count _return,["O_Heli_Light_02_unarmed_F",500000]];
			_return set[count _return,["O_Heli_Transport_04_F",1575000]];
			_return set[count _return,["O_Heli_Transport_04_covered_F",2025000]];
		};
	};
	...
	case "asa_car":
	{
		...
		{
			_return set[count _return,["C_Hatchback_01_sport_F",65000]];
			_return set[count _return,["C_SUV_01_F",25000]];
