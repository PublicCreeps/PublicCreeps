...
class marketView
{
	...
	class controlsBackground
	{
		...
		{
			idc = 1100;
			text = "<t size='1.2' align='center'>Altis Marktpreise</t>"; //--- ToDo: Localize;
		...
		{
			idc = 1001;
			text = "Was ist das? 0 $"; //--- ToDo: Localize;
			x = 17 * GUI_GRID_W + GUI_GRID_X;
			y = 5.5 * GUI_GRID_H + GUI_GRID_Y;
			w = 17 * GUI_GRID_W;
			h = 2.5 * GUI_GRID_H;
		...
		{
			idc = 1101;
			text = "<t align='center'>Preisänderung</t>"; //--- ToDo: Localize;
			x = 17 * GUI_GRID_W + GUI_GRID_X;
		...
		{
			idc = 1002;
			text = "Änderung seit Start"; //--- ToDo: Localize;
		...
		{
			idc = 1003;
			text = "Kürzliche Preisänderung"; //--- ToDo: Localize;
			x = 20.5 * GUI_GRID_W + GUI_GRID_X;
			y = 13.5 * GUI_GRID_H + GUI_GRID_Y;
			w = 13 * GUI_GRID_W;
			h = 1 * GUI_GRID_H;
		...
		{
			idc = 1004;
			text = "Was ist das 1? $"; //--- ToDo: Localize;
			x = 20.5 * GUI_GRID_W + GUI_GRID_X;
		...
		{
			idc = 1005;
			text = "Was ist das 2? $"; //--- ToDo: Localize;
			x = 20.5 * GUI_GRID_W + GUI_GRID_X;
