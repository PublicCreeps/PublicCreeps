...
_resourceZones = ["apple_1","apple_2","apple_3","apple_4","peaches_1","peaches_2","peaches_3","peaches_4","traube_1","traube_2","traube_3","traube_4","heroin_1","cocaine_1","weed_1","meth_1","sugarcane_1"];
_zone = "";
...
switch(true) do {
	...
	case (_zone in ["traube_1","traube_2","traube_3","traube_4"]): {_gather = "traube"; _val = 3;};
	case (_zone in ["meth_1"]): {_gather = "methu"; _val = 1;};
	case (_zone in ["sugarcane_1"]): {_gather = "sugarcane"; _val = 1;};
	default {""};
};
//gather check??
