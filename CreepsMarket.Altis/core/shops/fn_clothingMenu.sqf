...
//Cop / Civ Pre Check
if((_this select 3) in ["bruce","dive","reb","kart","donator","asa","adac"] && playerSide != civilian) exitWith {hint localize "STR_Shop_NotaCiv"; closeDialog 0;};
...
if((_this select 3) in ["medic"] && playerSide != independent) exitWith {hint "Du bist kein Sanitäter!"; closeDialog 0;};
if((_this select 3) in ["dive"] && !license_civ_dive) exitWith { hint localize "STR_Shop_NotaDive"; closeDialog 0;};
if((_this select 3) == "asa" && !license_civ_asa) exitWith {hint "Du bist kein ASA Mitglied!"; closeDialog 0;};
if((_this select 3) == "adac" && !license_civ_adac) exitWith {hint "Du bist kein ADAC Mitglied!"; closeDialog 0;};
