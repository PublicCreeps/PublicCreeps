...
switch (_var) do
{
	...
	case "life_inv_schmerzmittel": {"Schmerzmittel"};
	case "life_inv_traube": {"Traube"};
	case "life_inv_methu": {"Unverarbeitetes Meth"};
    case "life_inv_methp": {"Crystal Meth"};
    case "life_inv_sugarcane": {"Zuckerrohr"};
	...
	case "license_civ_sugar": {"Zucker herstellen"};
	case "license_civ_asa": {"ASA Shop Lizenz"};
	case "license_civ_adac": {"ADAC Shop Lizenz"};
	case "license_civ_donator": {"Donator Spawn Lizenz"};
};
