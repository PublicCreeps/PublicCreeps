...
switch (_className) do
{
	...
	case "I_G_Van_01_transport_F": {75};
	...
	case "I_Heli_Transport_02_F": {230};
	case "C_Rubberboat": {45};
	case "O_Boat_Armed_01_hmg_F": {0};
	case "B_Boat_Armed_01_minigun_F": {0};
	case "I_Boat_Armed_01_minigun_F": {0};
	case "B_G_Boat_Transport_01_F": {45};
	case "B_Boat_Transport_01_F": {45};
	case "O_Truck_03_transport_F": {270};
	case "O_Truck_03_covered_F": {350};
	case "O_Truck_03_device_F": {650};
	case "Land_CargoBox_V1_F": {5000};
	case "Box_IND_Grenades_F": {350};
	case "B_supplyCrate_F": {700};
	case "C_Van_01_fuel_F": {95};
	case "B_Truck_01_fuel_F": {650};
	case "I_Truck_02_fuel_F": {250};
	case "O_Truck_03_fuel_F": {450};
	case "O_Truck_02_transport_F": {350};
	case "B_Truck_01_mover_F": {560};
	case "O_Truck_02_fuel_F": {550};
	case "O_Heli_Transport_04_repair_F": {150};
