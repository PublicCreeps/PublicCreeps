...
_Btn8 buttonSetAction "[life_pInact_curTarget] spawn life_fnc_copDriveRemove; closeDialog 0;";

//Drogentest
_Btn9 ctrlSetText "Drogentest";
_Btn9 buttonSetAction "[life_pInact_curTarget] spawn life_fnc_drugtest; closeDialog 0;";
