...
class Life_Client_Core
{
	...
	class Cop
	{
		...
		class copYelp {};
		class radarCam {};
		class copDriveRemove {};
		class copDriveRemoveNow {};
		class drugtest {};
...
class Advanced_Jail
{
	...
	class Action {
		...
		file = "core\jail\action";
		

		class lockpickGateAction {};
		class toggleGateLockAction {};
		class laptopAction {};
	};
